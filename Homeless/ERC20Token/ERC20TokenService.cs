...
namespace Homeless.Contracts.ERC20Token
{
    public partial class ERC20TokenService
    {
        ...
        public ERC20TokenService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
        ...
        public Task<string> ChangeIssuerRequestAsync(ChangeIssuerFunction changeIssuerFunction)
        {
             return ContractHandler.SendRequestAsync(changeIssuerFunction);
        }

        public Task<TransactionReceipt> ChangeIssuerRequestAndWaitForReceiptAsync(ChangeIssuerFunction changeIssuerFunction, CancellationTokenSource cancellationToken = null)
        {
             return ContractHandler.SendRequestAndWaitForReceiptAsync(changeIssuerFunction, cancellationToken);
        }

        public Task<string> ChangeIssuerRequestAsync(string newIssuer)
        {
            var changeIssuerFunction = new ChangeIssuerFunction();
                changeIssuerFunction.NewIssuer = newIssuer;
            
             return ContractHandler.SendRequestAsync(changeIssuerFunction);
        }

        public Task<TransactionReceipt> ChangeIssuerRequestAndWaitForReceiptAsync(string newIssuer, CancellationTokenSource cancellationToken = null)
        {
            var changeIssuerFunction = new ChangeIssuerFunction();
                changeIssuerFunction.NewIssuer = newIssuer;
        ...
        public Task<string> IssueTokenToDonorRequestAsync(IssueTokenToDonorFunction issueTokenToDonorFunction)
        {
             return ContractHandler.SendRequestAsync(issueTokenToDonorFunction);
        }

        public Task<TransactionReceipt> IssueTokenToDonorRequestAndWaitForReceiptAsync(IssueTokenToDonorFunction issueTokenToDonorFunction, CancellationTokenSource cancellationToken = null)
        {
             return ContractHandler.SendRequestAndWaitForReceiptAsync(issueTokenToDonorFunction, cancellationToken);
        }

        public Task<string> IssueTokenToDonorRequestAsync(List<DonorIssuance> donorIssuance)
        {
            var issueTokenToDonorFunction = new IssueTokenToDonorFunction();
                issueTokenToDonorFunction.DonorIssuance = donorIssuance;
            
             return ContractHandler.SendRequestAsync(issueTokenToDonorFunction);
        }

        public Task<TransactionReceipt> IssueTokenToDonorRequestAndWaitForReceiptAsync(List<DonorIssuance> donorIssuance, CancellationTokenSource cancellationToken = null)
        {
            var issueTokenToDonorFunction = new IssueTokenToDonorFunction();
                issueTokenToDonorFunction.DonorIssuance = donorIssuance;
        ...
        public Task<string> IssuerQueryAsync(IssuerFunction issuerFunction, BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryAsync<IssuerFunction, string>(issuerFunction, blockParameter);
        }

        
        public Task<string> IssuerQueryAsync(BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryAsync<IssuerFunction, string>(null, blockParameter);
        }
